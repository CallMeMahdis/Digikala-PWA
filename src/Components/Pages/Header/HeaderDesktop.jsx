...
import "swiper/css";
import SearchBoxDesktop from "../SearchBox/SearchBoxDesktop";
...
const HeaderDesktop = () => {
  return (
    <div className="w-full fixed top-0 left-0 bg-white z-50">
      <header className="w-full h-[168px] flex flex-col relative">
        {/* Advertisement */}
        <TopAd />

        <div className="w-full relative">
          <div className="w-full h-[72px] flex container-4xl-w relative mx-auto justify-between md:px-4 lg:px-4 grow">
            <div className="w-full flex relative">
              {/* Right Side of Header */}
              <div className="lg:flex hidden shrink basis-0 items-center grow">
                {/* Logo */}
                <a className="ml-5 shrink-0" href="#">
                  <div className="w-[200px] h-[25px] leading-0">
                    <svg
              ...
              <div className="lg:flex hidden items-center justify-end">
                {/* Notifications */}
                <a className="flex justify-center items-center shrink-0 cursor-pointer relative p-2 ml-3">
                  <BiBell className="w-[25px] h-[25px] text-gray-700" />
                </a>

                {/* SignIn/SignUp */}
                <a>
                  <button className="flex items-center relative rounded-md whitespace-nowrap border border-neutral-200 cursor-pointer shrink-0 ml-2 lg:ml-0 text-button-2 px-[18px] py-2 leading-2">
                    <div className="flex items-center justify-center relative grow font-Bold text-[12px]">
                      <div className="flex ml-2">
                        <HiOutlineLogin className="w-[23px] h-[23px] text-gray-700" />
                      </div>
                      ورود | ثبت‌نام
                    </div>
                  </button>
                ...
                {/* Divider */}
                <span className="bg-neutral-300 mx-3 hidden lg:block divider mt-[22px]"></span>

                {/* Shopping Cart */}
                <div className="flex flex-col relative">
                  <a
                    className="inline-flex relative pr-2 pl-0 lg:p-2 rounded py-2"
                    href="#"
                  >
                    <div className="flex">
                      <RiShoppingCartLine className="text-gray-700 scale-x-[-1] w-[23px] h-[23px]" />
                    </div>
                  </a>
                </div>
              </div>
